...
public class SellerProfile  implements java.io.Serializable {
    private com.amazon.soap.SellerProfileDetails[] sellerProfileDetails;

    public SellerProfile() {
    }

    public SellerProfile(
           com.amazon.soap.SellerProfileDetails[] sellerProfileDetails) {
           this.sellerProfileDetails = sellerProfileDetails;
    }


    /**
     * Gets the sellerProfileDetails value for this SellerProfile.
     * 
     * @return sellerProfileDetails
     */
    public com.amazon.soap.SellerProfileDetails[] getSellerProfileDetails() {
        return sellerProfileDetails;
    }


    /**
     * Sets the sellerProfileDetails value for this SellerProfile.
     * 
     * @param sellerProfileDetails
     */
    public void setSellerProfileDetails(com.amazon.soap.SellerProfileDetails[] sellerProfileDetails) {
        this.sellerProfileDetails = sellerProfileDetails;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SellerProfile.class, true);
